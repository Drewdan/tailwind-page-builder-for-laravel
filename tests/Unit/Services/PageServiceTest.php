...
class PageServiceTest extends TestCase {
	...
	public function testReturnsListOfRoutes() {
		Page::factory()->create(['label' => 'Test Page', 'slug' => 'test-page']);
		Page::factory()->create(['label' => 'Test Page 2', 'slug' => 'test-page-2']);
	...
	public function testCanBuildPageFromJson() {
		...
		$this->assertEquals('<div class="grid md:grid-cols-4 content-start p-5 gap-4"><div class="col-span-4" ><h1 >Header 1</h1></div><div class="col-span-4" ><div class="flex flex-col gap-12" ><p >Paragraph</p><p >Paragraph</p><p >Paragraph</p><img class="object-contain" alt="Placeholder Image" src="https://davies-florist.eu-central-1.linodeobjects.com/c5924211-fffb-4caa-880d-8a1c4258b97b" /></div></div></div>', $html);
	}
